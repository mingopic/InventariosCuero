 ...
 * @author Domingo Luna
 */
public class CueroSeleccionado {
    int idCueroSeleccionado;
    int noPartida;
    String tipoProducto;
    String calibre;
    String seleccion;
    ...
    public int getIdCueroSeleccionado() {
        return idCueroSeleccionado;
    }

    public void setIdCueroSeleccionado(int idCueroSeleccionado) {
        this.idCueroSeleccionado = idCueroSeleccionado;
    }
