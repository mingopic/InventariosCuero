...
public class ProductoSaldo {
    ...
    public int getIdProductoSaldo() {
        return idProductoSaldo;
    }

    public void setIdProductoSaldo(int idProductoSaldo) {
        this.idProductoSaldo = idProductoSaldo;
    }
